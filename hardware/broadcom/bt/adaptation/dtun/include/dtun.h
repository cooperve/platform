...
// CK - Blocklist support for Gingerbread
    DTUN_METHOD_DM_BLOCK_DEV,       /* block/unlock bluetooth device with bt address */
...
/* 
 * BT device default name
 * The definition of flags are defined in the 'externel/bluetooth/bluez/src/Android.mk'
 */
#ifdef	BRCM21553_TOTORO_BT
#define DTUN_DEFAULT_DEV_NAME "GT-S5360"
#elif	BRCM21553_S5360T_BT
#define DTUN_DEFAULT_DEV_NAME "GT-S5360T"
#elif	BRCM21553_S5363_BT
#define DTUN_DEFAULT_DEV_NAME "GT-S5363"
#elif	BRCM21553_S5369_BT
#define DTUN_DEFAULT_DEV_NAME "GT-S5369"
#elif	BRCM21553_LUSIA_BT
#define DTUN_DEFAULT_DEV_NAME "GT-B5510"
#elif	BRCM21553_S5570I_BT
#define DTUN_DEFAULT_DEV_NAME "GT-S5570I"
#else
...
typedef struct
{
    tDTUN_HDR           hdr;
    bdaddr_t            bdaddr;
// CK - extend to support OOB for Gingerbread
    uint8_t				support_oob;
// CK - End - extend to support OOB for Gingerbread
    uint16_t            cod;
    /* params */
} tDTUN_BOND;
...
/* New SDP record information */
typedef struct
{
    tDTUN_HDR            hdr;
    uint8_t              data[4096];
} tDTUN_METHOD_DM_ADD_SDP_REC_EX;   

typedef struct
{
    tDTUN_HDR           hdr;
    uint32_t            handle;  
} tDTUN_METHOD_DM_REMOVE_SDP_REC_EX;
...
typedef struct
{
    ...
    uint16_t            rssi;
    uint32_t            cod;
    uint8_t             eir_present;    //do we have eir available
    uint8_t             eir[240];       //max eir size including signigicant + non significant part
...
} tDTUN_SIG_SDP_ADD_RECORD;

typedef struct
{
    tDTUN_HDR   hdr;
    uint32_t    retCode;
} tDTUN_SIG_SDP_REMOVE_RECORD;
...
// CK - Blocklist support for Gingerbread
    tDTUN_METHOD_DM_BLOCK_DEV           block_dev;
// CK - End - Blocklist support for Gingerbread
    ...
    /* sdp method calls */
    tDTUN_METHOD_DM_ADD_SDP_REC_EX      sdp_add_record;
    tDTUN_METHOD_DM_REMOVE_SDP_REC_EX   sdp_remove_record;
...
// CK - OOB support for Gingerbread
    tDTUN_SIG_DM_LOCAL_OOB_KEYS		local_oob_keys;
// CK - End - OOB support for Gingerbread
    ...
    tDTUN_SIG_SDP_ADD_RECORD          sdp_add_rec;
    tDTUN_SIG_SDP_REMOVE_RECORD       sdp_remove_rec;
