...
#if defined(FEATURE_MEA_JP) //SISO_MEA_JP
...
RenderText::RenderText(Node* node, PassRefPtr<StringImpl> str)
     ...
     , m_minWidth(-1)
#if defined(FEATURE_MEA_JP)
     , m_text(str)//, m_text(document()->displayStringModifiedByEncoding(str))//[[SISO BIDI Solution Changes for Callisto <Srini.siddi> Start
#else
